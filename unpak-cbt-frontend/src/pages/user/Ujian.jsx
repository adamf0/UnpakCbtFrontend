...
const UjianMaba = () => {
    ...
    const handleTrialExam = () => {
        try {
            ...
            alert(
                "Terjadi kesalahan saat memulai uji coba. Silakan coba lagi.",
            );
        } finally {
            setIsLoading(false);
        }
        ...
        <>
            <div className="flex bg-purple-400 flex-col items-center justify-center min-h-[100vh] px-4 py-4">
                ...
                <p className="text-white mb-8">
                    di Portal Computer Based Test (CBT).
                </p>
                                    ...
                                    <div className="mt-4 px-4 py-3 bg-red-100 border border-red-400 text-red-600 rounded-lg text-center">
                                        <div className="flex justify-center items-start gap-2">
                                            <p className="text-sm font-medium">
                                                Anda tidak dapat memulai ujian
                                                karena status ujian Anda tidak
                                                aktif. Harap lapor ke admin PMB
                ...
                <div className="text-sm text-center text-white mt-5">
                    © {new Date().getFullYear()} Universitas Pakuan. All Rights
                    Reserved.
                </div>
            </div>
        </>
