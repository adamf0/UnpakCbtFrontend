  ...
  useEffect(() => {
    ...
    if (jadwal) {
      timer = setInterval(() => {
        ...
        const start = new Date(`${jadwal.tanggal}T${jadwal.jamMulai}:00+07:00`);
        const end = new Date(`${jadwal.tanggal}T${jadwal.jamAkhir}:00+07:00`);
    ...
    <>
      <div className="flex bg-purple-400 flex-col items-center justify-center min-h-[100vh] px-4 py-4">
        <div className="flex justify-center mb-4">
          <Suspense
            fallback={<div className="text-center py-10">Loading logo...</div>}
          >
            <Logo />
          </Suspense>
        </div>
            ...
            <>
              ...
              <div className="px-6 pt-8 pb-4 space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm text-gray-500">Jam Sekarang</span>
                    <span className="font-semibold text-gray-800 text-lg">
