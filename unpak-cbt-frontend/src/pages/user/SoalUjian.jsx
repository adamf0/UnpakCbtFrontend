        ...
        const fetchData = async () => {
            try {
                ...
                const timer = setInterval(() => {
                    ...
                    const end = new Date(
                        `${jadwal.tanggal}T${jadwal.jamAkhir}:00+07:00`,
                    );
    ...
    const kirimJawaban = async (uuidTemplateSoal, uuidJawabanBenar) => {
        ...
        try {
            ...
            setAnsweredQuestions(
                (prev) =>
                    new Map([...prev, [uuidTemplateSoal, uuidJawabanBenar]]),
            );
        } catch (error) {
                                    ...
                                    currentIndex !== null && (
                                        <>
                                            ...
                                            <div className="space-y-4 mt-4">
                                                {jawabanForCurrentPertanyaan.map(
                                                    (jwb) => (
                                                        <label
                                                            key={jwb.uuid}
